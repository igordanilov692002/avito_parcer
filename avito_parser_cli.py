...
if __name__ == '__main__':
    ...
    with open(args.output, "w", newline='') as out_file:
        ...
        for ad in get_all_ads(args.query, sort_by=args.sortby, by_title=args.bytitle,
            ...
            if (args.minprice and not ad['Price']) or (args.minprice and ad['Price'] and ad['Price'] < args.minprice):
                continue
            if (args.maxprice and not ad['Price']) or (args.maxprice and ad['Price'] and ad['Price'] > args.maxprice):
                continue
